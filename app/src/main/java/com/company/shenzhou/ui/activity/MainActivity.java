...
//  6.5     53
        ...
        LinearLayout linear_content = findViewById(R.id.linear_content);
        int screenWidth = ScreenSizeUtil.getScreenWidth(MainActivity.this);
        int screenHeight = ScreenSizeUtil.getScreenHeight(MainActivity.this);
...
//                    1280*960   AR分辨率
            linear_content.setLayoutParams(layoutParams);
        } else {
